  ...
  return (
    <div className="flex flex-col  gap-4 px-4 pb-3 my-[130px] md:my-[105px]   md:max-w-[45rem] mx-auto w-full leading-[1.7rem] font-[330] text-black ">
      ...
      <p>
        ...
        Whether you&apos;re a passionate home cook, a curious foodie, or someone who
        just loves to savor the art of dining, you&apos;ve found the perfect place.
      </p>

      <p>
        At SavoryTouch, we believe that food is more than just
        nourishment&mdash; it&apos;s an adventure for the senses. Our mission is to
        inspire, inform, and share the love of food by providing a diverse range
        of recipes, cooking tips, and food culture insights. From easy weeknight
        dinners and gourmet meals to the latest trends in the culinary world, we
      ...
      <p>
        ...
        drink, SavoryTouch is your companion in the kitchen and beyond. We&apos;re
        constantly adding fresh, flavorful content that will inspire you to
        explore, create, and indulge in the richness of food and drink.
      </p>

      <p>
        Welcome to SavoryTouch&mdash;where every recipe is an adventure, and
        every meal is an opportunity to savor the moment. Let&apos;s cook, eat, and
        discover together.
      </p>
    </div>
  );
