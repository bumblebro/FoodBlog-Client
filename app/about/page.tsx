    ...
    <>
      ...
      {/* <div className="flex flex-col  gap-4 px-4 pb-3 my-[130px] md:my-[105px]   md:max-w-[45rem] mx-auto w-full leading-[1.7rem] font-[330] text-black ">
        <div className="container mx-auto px-4 py-12 text-left">
          ...
          <p className="mb-4">
            ...
            kitchen, we&apos;re here to make cooking fun, easy, and delicious.
            If you&apos;re looking for inspiration, check out our{" "}
            <strong>Recipes Section</strong>, featuring everything from
            comforting classics to bold, innovative dishes.
          </p>
          <p className="mb-4">
          ...
          <div className="flex items-center gap-4">
            <div>
              ...
              <p className="mb-4">
                Hi, I&apos;m Shreyas, the creator of Savory Touch! As a
                passionate foodie and tech enthusiast, I built this platform to
                share amazing recipes with the world. My goal is to bring
                together a community that loves cooking and experimenting with
                flavors. Whether you&apos;re looking for easy meal ideas or
                gourmet delights, I&apos;ve got you covered!
              </p>
              <p className="mb-4">
      ...
      <div className="flex flex-col gap-4 px-4 pb-3 my-[130px] md:my-[105px] md:max-w-[45rem] mx-auto w-full leading-[1.7rem] font-[330] text-black">
        <div className="container mx-auto px-4 py-12 text-left">
          ...
          <ul className="list-disc pl-6 mb-4">
            <li className="mb-2">
              A growing library of delicious recipes, from comforting classics
              to bold new favorites.
            </li>
            <li className="mb-2">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4">Meet the Creator</h2>
